 ...
 * @final
 */
class JanMikes_Slacker_SlackerKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'console.command.public_alias.JanMikes\\Slacker\\CheckMailCommand' => 'getCheckMailCommandService.php',
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/JanMikes_Slacker_SlackerKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.container_class' => 'JanMikes_Slacker_SlackerKernelDevDebugContainer',
            ...
            'console.command.ids' => [
                0 => 'console.command.public_alias.JanMikes\\Slacker\\CheckMailCommand',
            ],
        ];
    }
}
